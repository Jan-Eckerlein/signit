...
export interface paths {
    ...
    "/api/documents/{document_id}/open-for-signing": {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        get?: never;
        put?: never;
        post: operations["postApiDocumentsDocument_idOpenForSigning"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/pdf-process-uploads": {
        ...
        /**
         * Upload pdf(s)
         * @description Upload new raw pdfs to a pdf process.
         */
        post: operations["uploadPdfs"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface operations {
                ...
                content: {
                    "application/json": {
                        ...
                        data?: {
                            ...
                            name?: string;
                            /** @example 2025-07-19T14:23:42.000000Z */
                            created_at?: string;
                            /** @example 2025-07-19T14:23:42.000000Z */
                            updated_at?: string;
                        }[];
                ...
                content: {
                    "application/json": {
                        ...
                        data?: {
                            ...
                            ip?: string;
                            /** @example 2007-06-22T12:38:46.000000Z */
                            date?: string;
                            /** @example create */
                            icon?: string;
            ...
            200: {
                ...
                content: {
                    "application/json": {
                        ...
                        data?: unknown[];
                        links?: {
                            /** @example http://localhost:8001/api/document-signers?page=1 */
                            first?: string;
                            /** @example http://localhost:8001/api/document-signers?page=1 */
                            last?: string;
                            /** @example null */
                        ...
                        meta?: {
                            ...
                            /** @example http://localhost:8001/api/document-signers */
                            path?: string;
                            /** @example 20 */
                            per_page?: number;
                            /** @example null */
    ...
    postApiDocumentsDocument_idOpenForSigning: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    uploadPdfs: {
        ...
        requestBody: {
            content: {
                "multipart/form-data": {
                    /**
                     * @description The <code>id</code> of an existing record in the pdf_processes table.
                     * @example architecto
                     */
                    pdf_process_id: string;
                ...
                content: {
                    "application/json": {
                        data?: {
                            ...
                            /** @example 2023-08-17T00:00:00.000000Z */
                            value_date?: string;
                            /** @example null */
                            created_at?: string;
                            /** @example null */
                    ...
                    "application/json": {
                        ...
                        data?: {
                            ...
                            document_page?: {
                                ...
                                /** @example 1 */
                                page_number?: number;
                                /** @example 1995-04-18T04:57:21.000000Z */
                                created_at?: string;
                                /** @example 2013-07-11T07:12:47.000000Z */
                                updated_at?: string;
                            };
                        }[];
                        links?: {
                    ...
                    "application/json": {
                        data?: {
                            ...
                            document_page?: {
                                ...
                                /** @example 1 */
                                page_number?: number;
                                /** @example 2022-01-21T10:30:58.000000Z */
                                created_at?: string;
                                /** @example 2013-02-14T00:13:02.000000Z */
                                updated_at?: string;
                            };
                        };
                    };
                    ...
                    "application/json": {
                        data?: {
                            ...
                            document_page?: {
                                ...
                                /** @example 9 */
                                page_number?: number;
                                /** @example 1978-02-21T03:10:37.000000Z */
                                created_at?: string;
                                /** @example 1995-01-30T23:03:05.000000Z */
                                updated_at?: string;
                            };
                        };
                    };
                    ...
                    "application/json": {
                        data?: {
                            ...
                            document_page?: {
                                ...
                                /** @example 9 */
                                page_number?: number;
                                /** @example 1991-12-17T08:06:20.000000Z */
                                created_at?: string;
                                /** @example 1973-10-25T16:45:51.000000Z */
                                updated_at?: string;
                            };
                        };
                    };
            ...
            200: {
                ...
                content: {
                    "application/json": {
                        ...
                        data?: unknown[];
                        links?: {
                            /** @example http://localhost:8001/api/signs?page=1 */
                            first?: string;
                            /** @example http://localhost:8001/api/signs?page=1 */
                            last?: string;
                            /** @example null */
                        ...
                        meta?: {
                            ...
                            /** @example http://localhost:8001/api/signs */
                            path?: string;
                            /** @example 20 */
                            per_page?: number;
                            /** @example null */
                ...
                content: {
                    "application/json": {
                        data?: {
                            ...
                            /** @example 2 */
                            user_id?: number;
                            /** @example 2024-10-12T04:50:34.000000Z */
                            created_at?: string;
                            /** @example 2024-11-07T05:18:00.000000Z */
                            updated_at?: string;
                        };
                    };
                };
